...
export class ShoppingBagComponent implements OnInit {
  ...
  deleteCart(id: any) {
    ...
    this.apiService.deleteCart(values).subscribe((responseBody) => {
      ...
      if(response.res == true) {
        ...
        this.fetchCart();
        this.toast.success({detail: 'Cart item removed successfully',summary: '' ,duration: 4000});
      }
    },(error) => {
  ...
  handleCheckOut(id: any, price: any, brand_name: any, brand_key: any, brand_id: any) {
    this.btnDis = true;
