...
@Component({
  selector: 'app-after-login-local-brands',
  templateUrl: './after-login-local-brands.component.html',
  styleUrls: ['./after-login-local-brands.component.css']
})
export class AfterLoginLocalBrandsComponent implements OnInit {

  user_id!: any;
  brandList!: any;

  constructor(private apiService: ApiService, private storage: StorageMap, private router: Router) { }
  ...
  ngOnInit(): void {
    this.storage.get('user_session').subscribe({
      next: (user) => {
        ...
        this.fetchBrands(user_session.id);
      },
      error: (error) => {
      },          
    });
  ...
  localBannerHeading = "Brands Wholesale";
