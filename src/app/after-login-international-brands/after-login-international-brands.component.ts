...
@Component({
  selector: 'app-after-login-international-brands',
  templateUrl: './after-login-international-brands.component.html',
  styleUrls: ['./after-login-international-brands.component.css']
})
export class AfterLoginInternationalBrandsComponent implements OnInit {
  ...
  localBannerHeading = "International Brands";
