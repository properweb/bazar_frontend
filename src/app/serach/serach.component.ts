...
export class SerachComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.params.subscribe((routeParams) => {
      ...
      this.searchValue = routeParams['value'];
      this.getSearchProducts(routeParams['value']);
  ...
  getSearchProducts(value: any) {
    this.apiService.searchResultProductApi(value).subscribe((responseBody) => {
      let response = JSON.parse(JSON.stringify(responseBody));
