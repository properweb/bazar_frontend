...
@Component({
  selector: 'app-international-brands',
  templateUrl: './international-brands.component.html',
  styleUrls: ['./international-brands.component.css']
})
export class InternationalBrandsComponent implements OnInit {
  ...
  localBannerHeading = "International Brands Wholesale";
  ...
  localCategoryArray:any = [
    ...
    {
      imgName: "assets/images/explore-categories-img2.png",
  ...
  intCategoryArray:any = [
    {
      imgName: "assets/images/explore-categories-img1.jpg",
      titleName: "Shop Greeting Cards3"
    },
    {
      imgName: "assets/images/explore-categories-img2.jpg",
      titleName: "Shop Accessories3"
    },
    {
      imgName: "assets/images/explore-categories-img3.jpg",
      titleName: "Shop Candles3"
    },
    {
      imgName: "assets/images/explore-categories-img4.jpg",
      titleName: "Shop Women's clothes3"
    },
    {
      imgName: "assets/images/explore-categories-img1.jpg",
      titleName: "Shop Greeting Cards3"
  ...
  internationalCarousel: OwlOptions = {
    loop: true,
    mouseDrag: true,
    touchDrag: true,
    pullDrag: true,
