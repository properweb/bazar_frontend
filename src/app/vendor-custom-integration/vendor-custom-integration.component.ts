...
@Component({
  selector: 'app-vendor-custom-integration',
  templateUrl: './vendor-custom-integration.component.html',
  styleUrls: ['./vendor-custom-integration.component.css']
})
export class VendorCustomIntegrationComponent implements OnInit {
  ...
  customWebsiteConnect(customWebsiteConnectForm:any) {
    this.spinnerShow = true;
    let values = {
      api_key: customWebsiteConnectForm.value.api_key,
      api_password: customWebsiteConnectForm.value.api_password,
      store_url: customWebsiteConnectForm.value.store_url
    }
    this.apiService.customAddWebsite(values).subscribe((responseBody) => {
      let response = JSON.parse(JSON.stringify(responseBody));
      if(response.res === false) {
        ...
        this.spinnerShow = false;
        customWebsiteConnectForm.resetForm();
      }
